...
/////////////////
const BotName = 'JIDUNS BOT☄'; 
const instagram = 'https://www.instagram.com/ziiphy?r=nametag'; 
const telegram = '________'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = '________';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@ziiphy')
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by ig:@ziiphy`)
})
